          ...
          <ul className="flex space-x-2">
            {navLinks.map((link) => (
              <li key={link.name}>
                ...
                >
                  <span className={`relative z-10 ${activeLink === link.path ? 'text-white' : 'text-blue-300/90 hover:text-white'}`}>
                    {link.name}
                  </span>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.name}>
                  <Link 
                    to={link.path}
                    className={`block py-2 px-3 rounded-md transition-colors ${activeLink === link.path ? 'bg-blue-900/50 text-white' : 'text-blue-300/90 hover:text-white hover:bg-blue-900/30'}`}

...
//     { name: "Product Photography", price: "LKR 8,000/product", icon: "📸" },
//     { name: "Content Writing", price: "LKR 5,000/page", icon: "✍️" },
//     { name: "Monthly Maintenance", price: "LKR 15,000/mo", icon: "⚙️" },
//     { name: "Marketing Setup", price: "LKR 20,000", icon: "📢" },
//     { name: "Premium Hosting", price: "LKR 8,000/yr", icon: "🖥️" }
//   ];
...
//             E-commerce <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Packages</span>
//           </h1>
...
//                 <p className="text-gray-400 text-sm mb-4">{pkg.productLimit}</p>
